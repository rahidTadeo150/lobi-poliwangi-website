    ...
    <div class="flex flex-row h-fit">
        ...
        <div class="pl-72 pr-6 pt-5 w-full h-full">
            <div>
                ...
                <div class="mb-6">
                <div class="block -ml-4 max-w-sm min-w-full p-3 pl-6 pr-6 pb-2 bg-white border-l-8 border border-gray-300 border-l-sky-400 rounded-lg shadow">
                    <p class="text-md font-semibold tracking-tight text-gray-900 dark:text-white">{{ $data->nama_instansi_lomba}}</p>
                ...
                <div>
                    <form action="/dashboard-admin/tambah-data-lomba" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="flex flex-row justify-between items-center">
                            <div>
                                <div class="relative z-0 w-96 mb-5">
                                    <input name="namaLomba" autocomplete="off" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                        ...
                        <div class="flex flex-row">
                            ...
                            <input type="hidden" name="namaInstansi" value="{{ $data->nama_instansi_lomba }}">
