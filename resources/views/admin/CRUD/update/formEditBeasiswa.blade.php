        ...
        <div class="pl-72 pr-6 pt-5 w-full h-full">
            <div>
                ...
                <div class="block -ml-4 mb-10 max-w-sm min-w-full pt-2 pl-6 pr-6 pb-2 bg-white shadow-md border-l-8 border border-gray-300 border-l-sky-400 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p class="text-md font-semibold tracking-tight text-gray-900 dark:text-white">{{ $dataInstansi->nama_instansi_beasiswa }}</p>
            ...
            <div>
            <form action="/dashboard-admin/index-data-beasiswa/edit-data/{{ $data->id }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="flex flex-row justify-between items-center">
                    <div>
                        <div class="relative z-0 w-96 mb-5">
                            <input name="namaBeasiswa" value="{{ $data->nama_beasiswa }}" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                        ...
                        <div class="relative z-0 w-96 mb-9">
                            <input name="linkPendaftaran" value="{{ $data->link_pendaftaran }}" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                    ...
                    <div class="w-fit">
                        ...
                        <div class="flex items-center w-80 mr-32">
                            <div for="dropzone-file" class="flex flex-col items-center justify-center w-full h-96 border-2 border-gray-300 border-dashed rounded-lg bg-gray-50">
                                <div>
                                    <img src="{{ asset('/storage/' . $data->data_foto) }}" class="bg-contain w-full h-96">
                                </div>
                                <input name="imageNonchange" value="{{ $data->data_foto }}" type="hidden" class="hidden">
                ...
                <div class="flex flex-row">
                    ...
                    <button type="submit" class="ml-5 p-3 pl-8 pr-8 bg-blue-500 mt-10 mb-10 w-96 rounded-md">
                        <p class="text-gray-100 text-md font-semibold">Update Beasiswa</p>
                    </button>
                </div>
            </form>
        </div>
