...
<div class="w-full min-h-[593px] h-fit bg-white p-5 pt-6 mt-6 mb-6 rounded-md">
    <div class="flex flex-row justify-between items-center h-fit">
        <div class="w-fit">
            <p class="text-xl font-semibold">Notifikasi Lomba</p>
            <p class="text-sm font-normal">Daftar notifikasi pengajuan lomba</p>
        </div>
        <div class="w-2/5 flex flex-row justify-between">
            ...
            <button class="w-32 h-8 flex flex-col justify-center items-center rounded bg-sky-500 text-white">
                <p class="text-sm font-medium" disabled>Lomba</p>
            </button>
            ...
            <div class="w-full h-full flex flex-col justify-center">
                <div class="flex flex-row items-center">
                    ...
                    <div class="-mt-2">
                        ...
                        <p class="text-xs font-normal ml-2">Username ingin mengajukan lomba, lihat detail sekarang</p>
                    </div>
                </div>
                <a href="">
